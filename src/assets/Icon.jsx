/**
 * Icon registry — all icons sourced from src/assets/icons/*.svg
 * Usage: <Icon name="phone" className="w-4 h-4" />
 * Add new icons: copy SVG inner paths here and register below.
 */
...
const icons = {
  ...
  paw: (
    <g fill="currentColor" stroke="none">
      ...
      <path d="M12 10c-3.5 0-6 2.5-6 5.5 0 2 1.5 3.5 3 3.5.8 0 1.5-.3 2-.5.3-.1.7-.1 1 0 .5.2 1.2.5 2 .5 1.5 0 3-1.5 3-3.5 0-3-2.5-5.5-5-5.5z" />
    </g>
  ),
